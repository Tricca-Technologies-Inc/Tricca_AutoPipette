...
class Location:
    """Associate common places with a name and a Coordinate."""

    # Home
    home = Coordinate(0, 0, 0)

    # 100uL Tips Origin points
    # TODO Make a protocol to check all locations after toolhead changes.
    # TODO Create a way to convert coordinates between plate types
    tip_s3 = Coordinate(x=263, y=345, z=40.0)
    tip_s4 = Coordinate(x=310, y=147, z=40.0)  # TEMP Used for pipette tips
    ...
    # Vial Origin points
    vial1 = Coordinate(x=92, y=142, z=40)
    vial2 = Coordinate(x=201, y=0, z=40)
    vial3 = Coordinate(x=90, y=0, z=40)

    mvial = Coordinate(x=33.5, y=243.03, z=60)

    # Garbage positions
    garb_s5 = Coordinate(x=170, y=190, z=90.0)
